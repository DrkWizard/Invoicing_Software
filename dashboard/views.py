...
def dashboard(request):
     ...
     return render(request, 'dashboard/dashboard.html',{"customer_count":len(a),"product_count":len(b), "invoice_count":len(i), "total_revenue":total_revenue,'no_products': no_products})